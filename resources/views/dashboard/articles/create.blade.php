<x-dashboard>
    <section class="mx-4 bg-white dark:bg-gray-900">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        <label for="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Content</label>
                         <x-forms.tinymce-editor>content</x-forms.tinymce-editor>
                         @error('content')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">* {{ $message }}</p>
                        @enderror
                    </div>

                    <button type="submit" class="max-w-fit items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                        Add article
                    </button>
                </div>
            </form>
