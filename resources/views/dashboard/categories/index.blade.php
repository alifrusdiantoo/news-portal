						...
						<tbody class="text-center">
							...
							<tr class="border-b dark:border-gray-700">
								...
								<td class="px-4 py-3 flex justify-center">
									...
									<button onclick="openModal('delete-category-modal')" class="text-red-500">
	...
	<div id="delete-category-modal" class="fixed inset-0 hidden bg-gray-800 bg-opacity-75 z-50 flex items-center justify-center">
		<div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
			...
			<div class="flex justify-center items-center space-x-4">
				...
				<button onclick="closeModal('delete-category-modal')" class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Cancel</button>
			</div>
		</div>
	</div>
