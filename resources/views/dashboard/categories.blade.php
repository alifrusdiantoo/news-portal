<x-dashboard>
	...
	<section class="bg-gray-50 dark:bg-gray-900 antialiased">
		<div class="flex flex-row gap-4 mx-auto max-w-screen px-4 lg:px-4">
			<!-- Start coding here -->
			<div class="basis-1/2 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
					...
					<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
						...
						<tbody class="text-center">
							<tr class="border-b dark:border-gray-700">
								<td scope="row" class="px-4 py-3">1</td>
			...
			<!-- Form -->
			<div class="basis-1/2 p-4 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
				<h2 class="mb-4 text-md font-bold text-gray-900 dark:text-white">Add a new category</h2>
				<form class="">
					<div class="mb-5">
