<nav class="bg-blue-600" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <x-nav-link href="/" :active="request()->is('/') || request()->is('news')">Home</x-nav-link>
                        @foreach ($categories as $category)
                        <x-nav-link href="/categories/{{ $category->slug }}" :active="request()->is('{ $category->slug }')">{{ $category->name }}</x-nav-link>
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a href="#"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">News</a>
            <a href="#"
